...
const descriptionType = '0 - order sale, 1 - halmark, 2 - photography, 3-Gold testing, 4 - delivery reject, 5 - delivery proof reject , 6 - shop freez, 7 -order hold,10 - Cancel order, 11 - Amendment order';
