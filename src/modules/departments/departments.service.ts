...
export class DepartmentsService {
  ...
  async create(dto: DepartmentCreateDto, _userId_: string) {
    ...
    try {
      ...
      dto.array.map((mapItem) => {
        arrayToStates.push({
          ...
          _permissions: mapItem.permissions,
      ...
      var result1 = await this.departmentModel.insertMany(arrayToStates, {
  ...
  async list(dto: DepartmentListDto) {
    ...
    try {
      ...
      switch (dto.sortType) {
        ...
        case 4:
          arrayAggregation.push({
            $sort: { _processMasterStatus: dto.sortOrder ,_id: dto.sortOrder },
          });
          break;
      }
      ...
      var result = await this.departmentModel
      ...
      if (dto.screenType.includes( 0)) {
        ...
        var resultTotalCount = await this.departmentModel
          .aggregate(arrayAggregation)
          .session(transactionSession);
