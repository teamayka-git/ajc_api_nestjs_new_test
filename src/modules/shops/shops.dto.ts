...
const descriptionListScreenTypeForFilterLoading =
  '0-total documents count, 50-globalGalleryImagePopulate only if user details exist, 100-branch populate, 101-orderHead populate, 102-relationship manager populate,  104-rate card populate, 106-city populate, 107-tds populate, 108-tcs populate, 109-ratebase master populate, 110-agent populate, 111-user details populate,112- rate card percentages if ratecard details exist,                         ,200- general settings tax,201- general settings shop,202- general settings currency,203- general settings product,204- general settings order, 205-general settings invoice, 206-general settings other, 250-company details ';
