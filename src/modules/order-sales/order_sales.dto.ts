...
const descriptionListScreenTypeForBranchList =
  '0-total documents count,100-populate sub categories, 101-list documents, 102-customer id, 103-root cause populate, 104-order sale histories, 105-set process, 106-setprocess and sub process also';
