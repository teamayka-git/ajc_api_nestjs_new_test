...
const descriptionListScreenTypeForList =
  '0-total documents count, 100-user details, 101-delivery provider details, 102-delivery executive details, 103-root cause details, 104-created user details, 105-challan oitems';
