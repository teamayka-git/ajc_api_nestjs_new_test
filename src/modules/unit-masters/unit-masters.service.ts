...
import {
  ...
  UnitMasterEditDto,
  UnitMasterListDto,
  UnitMasterStatusChangeDto,
} from './process_master.dto';

@Injectable()
export class UnitMastersService {
  constructor(
    @InjectModel(ModelNames.UNIT_MASTER)
    private readonly unitMasterModel: mongoose.Model<UnitMaster>,
    ...
    try {
      ...
      switch (dto.sortType) {
        ...
        case 2:
          ...
          break;
        case 3:
          arrayAggregation.push({ $sort: { _value: dto.sortOrder  ,_id: dto.sortOrder} });
          break;
      }
