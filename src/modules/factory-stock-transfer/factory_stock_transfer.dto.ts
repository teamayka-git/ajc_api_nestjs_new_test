...
const descriptionListScreenTypeForList = '0-total documents count, 100-factory details, 101 - factory transfer items, 102 - factory transfer items under[101] group details, 103 - factory transfer items under[101] product temp list';
