...
import {
  ListFilterLocadingTestChargeDto,
  TestChargeMastersCreateDto,
  TestChargeMastersEditDto,
  TestChargeMastersListDto,
  TestChargeMastersStatusChangeDto,
} from './testChargeMasters.dto';

@Injectable()
export class TestChargeMastersService {
  constructor(
    @InjectModel(ModelNames.TEST_CHARGE_MASTERS)
    private readonly testChargeMastersModel: mongoose.Model<TestChargersMasters>,
  ...
  async create(dto: TestChargeMastersCreateDto, _userId_: string) {
    ...
    try {
      ...
      var result1 = await this.testChargeMastersModel.insertMany(
        arrayToStates,
        {
    ...
    try {
      ...
      switch (dto.sortType) {
        ...
        case 1:
          ...
          break;
        case 2:
          arrayAggregation.push({ $sort: { _charge: dto.sortOrder } });
          break;
      }
