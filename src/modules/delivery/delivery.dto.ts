...
const descriptionListScreenTypeForList =
  '0-total documents count,100-*shop details, 101-*employee details, 102-*hub details, 103-*delivery items list,104-*order details only if delivery items showing, 105-*invoice and items list only if delivery items showing,106-*employee global gallery only if employee details existing';
