...
const descriptionListScreenTypeForList =
  '0-total documents count, 100 - order sale item details, 101 - order sale main details, 102 - delivery details, 103 - invoice details, 104 - shop details, 105 - root cause details, 106 - order sale item under[100] sub category details';
